...
class Formfillup(models.Model):
    ...
    department = models.CharField(
        max_length=200, verbose_name='department', default='')

    exam_year = models.CharField(
        max_length=50, verbose_name='exam_year', default='')

    exam_starting_date = models.DateField(
        verbose_name='exam_starting_date', default=None, blank=True, null=True)
    ...
    last_semester = models.CharField(
        max_length=50, verbose_name='last_semester', default='')

    passing_year = models.CharField(
        max_length=50, verbose_name='passing_year', default='')

    result = models.CharField(
        max_length=50, verbose_name='result', default='')

    name = models.CharField(max_length=200, verbose_name='Name', )

    father = models.CharField(
        max_length=200, verbose_name='father', default='',)
    ...
    birth_date = models.DateField(
        verbose_name='birth_date', default=None, blank=True, null=True)

    nationality = models.CharField(
        max_length=200, verbose_name='nationality', default='')

    religion = models.CharField(
        max_length=200, verbose_name='religion', default='')

    village = models.CharField(
        max_length=200, verbose_name='village', default='')

    post_office = models.CharField(
        max_length=200, verbose_name='Post_office', default='',)
