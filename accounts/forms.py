...
class MyCustomSignupForm(SignupForm):
    ...
    # recreating form fields
        ...
        self.fields['student_id'] = forms.CharField(label='Enter Student ID',
                                        widget=forms.TextInput(attrs={'class': 'form-control', 'name': 'student_id', 'placeholder': 'student_id'}))
        self.fields['semester'] = forms.CharField(label='Enter semester',
                                                widget=forms.TextInput(attrs={'class': 'form-control', 'name': 'semester', 'placeholder': 'semester'}))
